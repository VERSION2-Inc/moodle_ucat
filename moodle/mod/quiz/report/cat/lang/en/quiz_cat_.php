...
/**
 * Strings for component 'quiz_cat', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   quiz_cat
...
$string['cat'] = 'CAT';
$string['catdownload'] = 'Cat download';
$string['catreport'] = 'Grades report';
$string['catreportgraph'] = 'Overall Number of Students Achieving Grade Ranges';
$string['catreportgraphgroup'] = 'Number of Students in Group \'{$a}\' Achieving Grade Ranges';
