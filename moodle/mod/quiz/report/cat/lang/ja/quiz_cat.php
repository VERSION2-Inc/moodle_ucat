...
/**
 * Strings for component 'quiz_cat', language 'ja', branch 'MOODLE_20_STABLE'
 *
 * @package   quiz_cat
...
$string['cat'] = 'CAT';
$string['catdownload'] = '概要のダウンロード';
$string['catreport'] = 'CATレポート';
$string['catreportgraph'] = '評点範囲に到達した学生の全体数';
$string['catreportgraphgroup'] = '到達した評点の範囲に関するグループ「 {$a} 」の学生数の棒グラフ';
...
$string['show'] = '次のデータを含む';
$string['showattempts'] = '次の受験を含む';
$string['showdetailedmarks'] = 'それぞれの問題の最大評点';
