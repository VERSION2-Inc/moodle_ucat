...
//-------------------------------------------------------------------------------
        ...
        $rows = $DB->get_records('cat_user_sets');
        $usets = array();
        foreach ($rows as $row) {
            $usets[$row->id] = $row->name;
        }
        $mform->addElement('header', 'cathdr',
                           get_string('catfeature', 'block_cat_manager'));
        $mform->addElement('selectyesno', 'usecatfeature',
                           get_string('usecatfeature', 'block_cat_manager'));
        $mform->addElement('select', 'userset',
                           get_string('usestudentlist', 'block_cat_manager'),
                           $usets);
        $mform->addElement(
            'select', 'catendcondition',
            get_string('endcondition', 'block_cat_manager'),
            array(CAT_ENDCOND_ALL
                  => get_string('allquestions', 'block_cat_manager'),
                  CAT_ENDCOND_NUMQUEST
                  => get_string('bynumquestions', 'block_cat_manager'),
                  CAT_ENDCOND_SE
                  => get_string('byse', 'block_cat_manager'),
                  CAT_ENDCOND_NUMQUESTANDSE
                  => get_string('bynumquestionsandse', 'block_cat_manager')));
        $mform->addElement('text', 'catnumquestions', get_string('numquestions', 'block_cat_manager'));
        $mform->setDefault('catnumquestions', 0);
        $mform->addElement('text', 'catstandarderror', get_string('standarderror', 'block_cat_manager'));
        $mform->setDefault('catstandarderror', 0);
        $mform->addElement('text', 'catlogitbias', get_string('logitbias', 'block_cat_manager'));
        $mform->setDefault('catlogitbias', 0);
        $mform->addElement('selectyesno', 'catrecord', get_string('catrecord', 'block_cat_manager'));
        ...
        // }
        // $mform->addElement('select', 'catquestioncategory', get_string('questioncategory', 'block_cat_manager'), $opts);
        //CATMOD END
