...
/**
 *
 * @param object $stateforqinattempt
 * @return bool
 */
function cat_quiz_report_is_question_answered($stateforqinattempt) {
    if (preg_match('/^[0-9,]+:([0-9]*)$/', $stateforqinattempt->answer, $m)) {
        $answer = $m[1];
    } else {
        $answer = $stateforqinattempt->answer;
    }
